<template>
    <div>
        ...
        <div>
         ...
         <Tabs type="card" class="user_table" style="margin-top:240px" v-model="menu_tab" @on-click="menu_pow(index)">
            <TabPane label="成员列表" name='user_tab'>
                <Button type="primary" @click="getRoot_dom(index)" style="width:100px;align-self: flex-end;margin-right:50px">菜单权限</Button>
        ...
        <!-- 菜单权限 树形图-->
        <Modal  v-model="showTranser1" :draggable=true title="设置角色菜单权限"
         @on-ok="isOkTree"
...
export default {
        ...
        data() {
            return {
                ...
                data1: [],
                data2:[] ,//左边的名字[{"key":'1',"lable":'one'},{"key":'2',"lable":'two'},{"key":"3","lable":'three'}]
                right_data:[],// 右边的名字["1","2"]
                data_tree:[{
                        title: '商品管理',
                        expand: false,
                        checked:true,
       ...
       mounted() {
            ...
            // axios({url:'http://www.baidu.com/usersArray'}).then(res=>{
       ...
       methods: {
          ...
          // console.log(data)
            ...
            for(let i=0;i<data.arr.length;i++){
                ...
                this.right_data.push(i.toString())
            }
              this.index = index
